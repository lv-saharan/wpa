export = wpa;
export as namespace wpa;

declare namespace wpa {
  ...
  abstract class Component<P = {}> {
    ...
    update(ignoreAttrs?: boolean, updateSelf?: boolean): void;
    lazyUpdate(ignoreAttrs?: boolean, updateSelf?: boolean): void;
    updateStyle(): void | Promise<void>;
    forceUpdate(): void;
    updateProps(obj: any): void;
    updateSelf(ignoreAttrs?: boolean): void;
    fire(name: string, data?: any): void;
...
declare global {
  namespace JSX {
    interface Element extends wpa.VNode<any> {}

    interface ElementClass extends wpa.WeElement<any> {}

    interface ElementClass extends wpa.Component<any> {}
    ...
    interface DOMAttributes extends wpa.OmiDOMAttributes {
      // Image Events
    ...
    interface HTMLAttributes extends wpa.ClassAttributes<any>, DOMAttributes {
